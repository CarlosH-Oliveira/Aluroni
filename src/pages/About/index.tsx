			...
			<div className={styles.main}>
				<div className={styles.aboutUs}>
					<div className={styles.image__container}>
						<img src={casa} alt="Casa Aluroni" className={styles.image}/>
						<div className={styles.aboutUs__text} style={{backgroundImage:casa}}>
							<p>
					...
					<div className={styles.images__container}>
						<img src={massa1} alt="Imagem de massa" className={styles.images}/>
						<img src={massa2} alt="Imagem de massa" className={styles.images}/>
					</div>
				</div>
			</div>
		</>
